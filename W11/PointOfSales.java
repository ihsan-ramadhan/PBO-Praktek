...
public class PointOfSales extends JFrame {
    ...
    private void initListeners() {
        produkTable.getSelectionModel().addListSelectionListener(e -> handleProductSelection(e));
    ...
    private void handleAddToCart() {
        ...
        double subtotal = selectedHarga * qty;
        ...
        for (int i = 0; i < keranjangModel.getRowCount(); i++) {
            if (keranjangModel.getValueAt(i, 0).equals(selectedId)) {
                ...
                double newSubtotal = selectedHarga * newQty;
    ...
    private void handleCheckout() {
        ...
        for (int i = 0; i < keranjangModel.getRowCount(); i++) {
            ...
            sb.append(String.format("%s %s %d %s\n", id, nama, qty, currencyFormatter.format(sub)));
        }
    ...
    private void handlePrint() {
        if (strukArea.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Tidak ada struk untuk dicetak.", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }
